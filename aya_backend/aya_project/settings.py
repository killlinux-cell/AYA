...
APP_ANDROID_MIN_VERSION_CODE = config('APP_ANDROID_MIN_VERSION_CODE', default=24, cast=int)
APP_ANDROID_LATEST_VERSION = config('APP_ANDROID_LATEST_VERSION', default='1.2.6')
