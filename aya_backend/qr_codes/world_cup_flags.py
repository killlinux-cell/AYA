...
ALPHA3_TO_ALPHA2 = {
    ...
    'KOR': 'kr', 'KUW': 'kw', 'LVA': 'lv', 'LBN': 'lb', 'LBY': 'ly', 'LTU': 'lt',
    'LUX': 'lu', 'MKD': 'mk', 'MLI': 'ml', 'MLT': 'mt', 'MAR': 'ma', 'MEX': 'mx',
    'MDA': 'md', 'MNE': 'me', 'NED': 'nl', 'NZL': 'nz', 'NGA': 'ng', 'NIR': 'gb',
    'NOR': 'no', 'OMN': 'om', 'PAN': 'pa', 'PAR': 'py', 'PER': 'pe', 'POL': 'pl',
    'POR': 'pt', 'QAT': 'qa', 'ROU': 'ro', 'RUS': 'ru', 'KSA': 'sa', 'SCO': 'gb',
    'SEN': 'sn', 'SRB': 'rs', 'SVK': 'sk', 'SVN': 'si', 'RSA': 'za', 'ESP': 'es',
    'SWE': 'se', 'SUI': 'ch', 'SYR': 'sy', 'TUN': 'tn', 'TUR': 'tr', 'UKR': 'ua',
    'UAE': 'ae', 'USA': 'us', 'URU': 'uy', 'UZB': 'uz', 'VEN': 've', 'WAL': 'gb',
    'ZAM': 'zm', 'ZIM': 'zw',
}
...
def get_country_flag_url(code: str | None, width: int = 40) -> str | None:
    ...
    if not alpha2:
        return None
    return f'https://flagcdn.com/w{width}/{alpha2}.png'
